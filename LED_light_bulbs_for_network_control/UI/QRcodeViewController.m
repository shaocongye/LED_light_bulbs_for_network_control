...
- (void)viewDidLoad
{
    ...
    self.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"ShowLight" image:[UIImage imageNamed:@"icon.png"] tag:0];
    ...
    //创建一个导航栏集合
    UINavigationItem *navigationItem = [[UINavigationItem alloc] initWithTitle:@"ShowLight"];
